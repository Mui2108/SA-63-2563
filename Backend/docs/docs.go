...
var doc = `{
    ...
    "definitions": {
        ...
        "ent.JobEdges": {
            ...
            "properties": {
                "jobs": {
                    "description": "Jobs holds the value of the jobs edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Patient"
                    }
        ...
        "ent.Patient": {
            ...
            "properties": {
                ...
                "Fist_name": {
                    "description": "FistName holds the value of the \"Fist_name\" field.",
                    "type": "string"
                },
                "Last_name": {
        ...
        "ent.PatientEdges": {
            ...
            "properties": {
                ...
                "patients1": {
                    "description": "Patients1 holds the value of the patients1 edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.Title"
                },
                "patients2": {
                    "description": "Patients2 holds the value of the patients2 edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.Job"
                }
            }
