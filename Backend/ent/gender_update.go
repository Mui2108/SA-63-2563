...
func (gu *GenderUpdate) SetGenderType(s string) *GenderUpdate {
	gu.mutation.SetGenderType(s)
	return gu
}

// SetGenID sets the gen edge to Patient by id.
func (gu *GenderUpdate) SetGenID(id int) *GenderUpdate {
	gu.mutation.SetGenID(id)
	return gu
}

// SetNillableGenID sets the gen edge to Patient by id if the given value is not nil.
func (gu *GenderUpdate) SetNillableGenID(id *int) *GenderUpdate {
	if id != nil {
		gu = gu.SetGenID(*id)
	}
	return gu
...
func (gu *GenderUpdate) SetGen(p *Patient) *GenderUpdate {
	return gu.SetGenID(p.ID)
}
...
func (gu *GenderUpdate) ClearGen() *GenderUpdate {
	gu.mutation.ClearGen()
	return gu
}

// Save executes the query and returns the number of rows/vertices matched by this operation.
func (gu *GenderUpdate) Save(ctx context.Context) (int, error) {
	if v, ok := gu.mutation.GenderType(); ok {
		if err := gender.GenderTypeValidator(v); err != nil {
			return 0, &ValidationError{Name: "Gender_type", err: fmt.Errorf("ent: validator failed for field \"Gender_type\": %w", err)}
		}
	}
...
func (gu *GenderUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := gu.mutation.GenderType(); ok {
	...
	if nodes := gu.mutation.GenIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   gender.GenTable,
...
// SetGenderType sets the Gender_type field.
func (guo *GenderUpdateOne) SetGenderType(s string) *GenderUpdateOne {
	guo.mutation.SetGenderType(s)
	return guo
}

// SetGenID sets the gen edge to Patient by id.
func (guo *GenderUpdateOne) SetGenID(id int) *GenderUpdateOne {
	guo.mutation.SetGenID(id)
	return guo
}

// SetNillableGenID sets the gen edge to Patient by id if the given value is not nil.
func (guo *GenderUpdateOne) SetNillableGenID(id *int) *GenderUpdateOne {
	if id != nil {
		guo = guo.SetGenID(*id)
	}
	return guo
...
// SetGen sets the gen edge to Patient.
func (guo *GenderUpdateOne) SetGen(p *Patient) *GenderUpdateOne {
	return guo.SetGenID(p.ID)
}
...
// ClearGen clears the gen edge to Patient.
func (guo *GenderUpdateOne) ClearGen() *GenderUpdateOne {
	guo.mutation.ClearGen()
	return guo
}

// Save executes the query and returns the updated entity.
func (guo *GenderUpdateOne) Save(ctx context.Context) (*Gender, error) {
	if v, ok := guo.mutation.GenderType(); ok {
		if err := gender.GenderTypeValidator(v); err != nil {
...
func (guo *GenderUpdateOne) sqlSave(ctx context.Context) (ge *Gender, err error) {
	...
	if value, ok := guo.mutation.GenderType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: gender.FieldGenderType,
	...
	if nodes := guo.mutation.GenIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   gender.GenTable,
