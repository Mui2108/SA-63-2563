...
func init() {
	...
	// patientDescFistName is the schema descriptor for Fist_name field.
	patientDescFistName := patientFields[1].Descriptor()
	// patient.FistNameValidator is a validator for the "Fist_name" field. It is called by the builders before save.
	patient.FistNameValidator = patientDescFistName.Validators[0].(func(string) error)
